...
var generateFeed = function(fn) {
	...
	\t<link>http://rtbfpodcast.nodester.com/rtbfpodcast.xml</link>\n';
    ...
    if(month<10) month = "0"+month;
		...
		var videoLink = "http://podvideo.prd.rtbf.be/redirect/rtbf_vod/folder-5430/copy-32/info__jt_"+ts+"__"+ts+".mp4";
